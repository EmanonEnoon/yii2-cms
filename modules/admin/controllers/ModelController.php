...
use app\models\searches\ModelSearch;
use Yii;
...
class ModelController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "新增模型",
                    'content' => '<span class="text-success">Create Model success</span>',
                    'footer' => Html::button('关闭', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Model model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Model model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
